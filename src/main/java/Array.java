...
public class Array{
	...
	public static void insert(int number,int position){
	...
	//function to do Linear Search on the array.
	 public static boolean linearSearch(int number){
		for(int i=0;i<size;i++){
			if(number==array[i]){
				return true;
			}
	...
	//function to to Binary Search on the array.
	 public static boolean binarySearch(int number,int low, int high){
		if(low>high){
			return false;
		}
	...
	/*public static void main(String [] args){
		...
		System.out.println(array.binarySearch(56,0,array.size)); //search for num=56 using Binary Search.
	}*/
}
